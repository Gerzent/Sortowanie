...
\title{Sprawozdanie-Algorytmy sortowania}
\author{Patryk Raduła i Jan Wójcik}
\begin{document}
	\maketitle
	\section{Informacje wstępne}
	\subsection{Język programowania}
	Wszystkie algorytmy sortowania zostały zaimplementowane w C. Generator danych wejściowych oraz program tworzący wykresy zostały zaimplementowane w Python.
	\subsection{Platforma na której wykonano testy}
	Testy przeprowadzono na komputerze osobistym o następującej specyfikacji:
	\begin{description}
		\item[System operacyjny] Windows 11 Home
		\item[Procesor] AMD Ryzen 5 7535HS with Radeon Graphics (3.30 GHz)
	...
	\end{figure}
		...
		\begin{minipage}{0.48\textwidth}
			\hspace*{-5cm}
			\includegraphics[scale=0.7]{../plotsAlgo/Heap_Exponential.png}
			\label{fig:heap_exponential}
		\end{minipage}
		\hfill
		
		\begin{minipage}{0.48\textwidth}
			\hspace*{-5cm}
			\includegraphics[scale=0.7]{../plotsAlgo/Heap_Linear.png}
			\label{fig:heap_linear}
		\end{minipage}
